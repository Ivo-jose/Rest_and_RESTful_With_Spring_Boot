...
public class BookController {
	...
	@Operation(summary = "Adds a new Book", description = "Adds a new Book by passing in a JSON, XML or YAML representation of the Book", 
	...
	@PutMapping(produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML},
			    consumes = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	@Operation(summary = "Updates a Book", description = "Updates a Book by passing in a JSON, XML or YAML representation of the Book", 
	  tags = {"Books"}, responses = {
	...
	@Operation(summary = "Deletes a Book", description = "Deletion with id passed by Path params", 
	  tags = {"Books"}, responses = {
	 	@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
	 	@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
	 	@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
