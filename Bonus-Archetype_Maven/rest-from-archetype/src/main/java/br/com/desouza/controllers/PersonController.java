...
import br.com.desouza.services.PersonServices;
import br.com.desouza.util.MediaType;
...
public class PersonController {
	...
	@Operation(summary = "Adds a new Person", description = "Adds a new Person by passing in a JSON, XML or YAML representation of the Person", 
	...
	@PutMapping(produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML},
			    consumes = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	@Operation(summary = "Updates a Person", description = "Updates a Person by passing in a JSON, XML or YAML representation of the Person", 
	  tags = {"People"}, responses = {
	...
	@Operation(summary = "Deletes a Person", description = "Deletion with id passed by Path params", 
	  tags = {"People"}, responses = {
	 	@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
	 	@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
	 	@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
